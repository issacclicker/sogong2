...
class _CategoryAddPageState extends State<CategoryAddPage> {
  final List<String> _categories = ['영수증빙자료', '보충영수증빙자료', '기타증빙자료'];
  ...
  void initState() {
    ...
    if (widget.initialCategory != null) {
      ...
      if (_defaultOptions.containsKey(_selectedCategory) &&
          _defaultOptions[_selectedCategory]!.isNotEmpty) {
  ...
  final Map<String, String> _tipMap = {
    //영수증빙자료
    '매출 전표(오프라인 카드결제)':
        '오프라인으로 카드결제시 발급되는 영수증입니다. 사업자정보, 거래내역, 거래날짜, 거래수단(카드번호)이 드러나야 합니다.',
    '카드 전표(온라인 카드결제)':
        '카드로 결제된 거래에 대해 은행에서 발급받을 수 있는 영수증입니다. 사업자 정보, 거래날짜, 결제금액, 카드번호가 드러나야 합니다.',
    '이체증(계좌이체,본통장입금)':
        '계좌이체 또는 무통장입금 시 발급되는 영수증입니다. 입/출금 계좌번호와 예금주명, 이체금액, 이체날짜, 수수료가 드러나야 합니다.',
    '현금영수증(현금결제)':
        '오프라인으로 현금결제 시 발급되는 영수증입니다. 사업자정보, 거래내역, 거래날짜, 거래수단(소득공제 번호)가 드러나야 합니다.',
    '결제취소전표(취소시 발급되는 영수증)':
        '결제가 취소된 경우 발급되는 영수증입니다. 사업자 정보, 거래금액, 거래날짜, 거래수단(카드번호)가 드러나야 합니다. 결산안에 환불 사유를 명시해야 합니다.',
    '거래내역서':
        '업체, 매장, 인터넷 구매 시 거래내역에 대해 알 수 있는 영수증입니다. 상호명, 사업자명, 사업자 직인(또는 서명), 거래내역, 거래날짜가 드러나야 합니다.',
    '간이영수증':
        '매장에서 수기로 발급해주는 영수증입니다. 상호명, 사업자명, 사업자 직인(또는 서명), 거래내역, 거래날짜가 드러나야 합니다.',
    '카드전표':
        '카드로 결제된 거래에 대해 은행에서 발급받을 수 있는 영수증입니다. 사업자 정보, 거래날짜, 결제금액, 카드번호가 드러나야 합니다.',
    //보충영수증빙자료
    ...
    '수기증':
        '학생회에서 학생회, 학생회에서 학우에게 돈을 지급하는 경우 작성하는문서입니다. 지급금액, 지급사유, 지급날짜, 공급하는 자/공급받는 자에 대한 정보가 드러나야 합니다.',
    '차용증명서':
        '학생회 간의, 동아리연합회와 동아리 간의 돈의 차용에 대해 작성하는 문서입니다. 차용금액, 변제기일, 이자, 차용하게 된 사유, 지급방법, 채권자와 채무자의 정보, 서명, 작성일이 드러나야 합니다.',
    //기타증빙자료
    '사진': '모든 행사에는 1개 이상의 사진자료를 필수적으로 제출해야 합니다.',
    '공지사항':
        '행사 집행에 대한 사실을 모두에게 공고했다는 것을 증빙하는 자료입니다. 공지의 주체, 공지내용, 공지날짜가 드러나야 합니다.',
    '차등회비선정 증빙자료': '차등회비가 선정된 사유를 증빙할 수 있는 자료입니다. 예산안이나 회의록 등이 적절합니다.',
    '대리작성동의 증빙자료':
        '양식이 제공되는 자료를 당사자를 대신하여 작성하는 경우 해당 사실에 동의했음을 증빙하는 자료입니다. 구글폼이나 카카오톡 투표 등이 적절합니다.',
    '회비 잔여금동의 증빙자료': '회비잔여금 기준을 넘어 회비가 남은 경우 해당 잔여금에 대한 처리방법에 대해 동의한 자료입니다.',
    '상품선정 증빙자료':
        '상품을 선정한 사유에 대해 증빙할 수 있는 자료입니다. 행사의 목적을 벗어나 과도하게 높은 금액의 상품으로 선정된 경우에 한하여 제출합니다.',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Padding(
        padding: const EdgeInsets.all(24), // 24pt padding
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8), // 8pt spacing
            DropdownButton<String>(
              value: _selectedCategory,
              isExpanded: true, // Make dropdown take full width
              underline:
                  Container(), // Remove default underline as per design system
              items: _categories
                  .map(
            ...
            const SizedBox(height: 24), // 24pt spacing
            ...
            const SizedBox(height: 32), // 32pt spacing
            // 3) 힌트 영역 (폴더 추가 시 숨김)
                ...
                children: [
                  ...
                  Row(
                    crossAxisAlignment: CrossAxisAlignment
                        .start, // Align icon and text at the top
                    children: [
                      const Icon(
                        Icons.info_outline,
                        size: 24,
            ...
            // 확정 버튼
            SizedBox(
              // Wrap with SizedBox to control button width
              ...
              child: ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.pop<Map<String, String>>(context, {
                    ...
                    'subcategory': widget.isForFolder
                        ? ''
                        : _selectedSubcategory, // 폴더 추가 시 소분류는 빈 문자열
